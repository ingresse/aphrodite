...
angular.module('aphrodite')
.factory('inject', ["$window", function ($window) {
    var factory = {};
...
angular.module('aphrodite')
.factory('loader', ["$timeout", function ($timeout) {
 ...
 */
angular.module('aphrodite')
.factory('scroll', ["$document", function ($document) {
    var factory = {};
...
angular.module('aphrodite')
.filter('momentum', ["moment", function (moment) {
...
angular.module('aphrodite')
.directive('aphAutocomplete', ["$timeout", "$filter", function ($timeout, $filter) {
    return {
        restrict   : 'E',
        replace    : true,
        scope      : {
...
angular.module('aphrodite')
.directive('creditcardBirthdate', ["moment", function (moment) {
    return {
        restrict: 'E',
        replace : true,
        scope   : {
...
angular.module('aphrodite')
.directive('creditcard', ["$window", function ($window) {
    return {
        restrict   : 'E',
        replace    : true,
...
angular.module('aphrodite')
.directive('creditcardExpiration', ["moment", function (moment) {
    return {
        restrict: 'E',
        replace : true,
        scope   : {
...
angular.module('aphrodite')
.directive('creditcardNumber', ["$filter", function ($filter) {
    return {
        restrict: 'E',
        replace: true,
        scope: {
...
angular.module('aphrodite')
.directive('creditcardValidator', ["$filter", function ($filter) {
    return {
        require: 'ngModel',
        link: function (scope, elm, attrs, ctrl) {
...
angular.module('aphrodite')
.directive('paymentFast', ["inject", function (inject) {
    return {
        restrict   : 'E',
        replace    : true,
        transclude : true,
